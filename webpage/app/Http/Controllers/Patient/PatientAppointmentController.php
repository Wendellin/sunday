...
class PatientAppointmentController extends Controller
{
    ...
    {
        $patient_id = Patient::select('id')->where('user_id', Auth::id())->get();

        $patient = Patient::where('user_id', Auth::id())->first();

        $appointments = Appointment::whereIn('patient_id', $patient_id)->latest()->get();
        $depts = Department::latest()->get();
        $aTimes = AppointmentTime::latest()->get();
        return view('patient.appointment.index', compact('patient', 'appointments', 'depts', 'aTimes', 'patient'));
    }
    ...
    public function create()
    {
        ...
        return view('assistant.appointment.create-page', compact('depts', 'aTimes'));
    }
    ...
    public function edit(string $id)
    {
        ...
        // return view('patient.appointment.edit', compact('appointment','patients', 'depts', 'aTimes'));
    }
