...
class AppointmentController extends Controller
{
    ...
    {
        $appointments = Appointment::all(); // order based on dates; todays appointsments first
    ...
    public function create()
    {
        ...
        return view('admin.appointment.create-page', compact('patients', 'depts', 'aTimes'));
    }
    ...
    public function edit(Appointment $appointment)
    {
        ...
        return view('admin.appointment.edit', compact('appointment','patients', 'depts', 'aTimes'));
    }
