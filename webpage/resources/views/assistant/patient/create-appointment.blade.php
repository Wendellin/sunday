<div class="modal fade" id="bookPatientAppointment-{{ $patient->id }}" tabindex="-1" aria-labelledby="bookPatientAppointmentLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="bookPatientAppointmentLabel">Book Appointment for {{ $patient->users->name }}</h1>
