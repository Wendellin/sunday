          ...
          <div class="iq-card">
             <div class="iq-card-header d-flex justify-content-between">
                <div class="iq-header-title">
                   <h4 class="card-title lh-lg"><span class="fw-bold">{{ $appointment->patients->users->name }}</span> <br> Appointment</h4>
                </div>
             </div>
          </div>
       </div>
                ...
                <div class="new-user-info">
                   <form action="{{ route('admin.appointments.update', $appointment->id) }}" method="post">
                    ...
                    @method('PUT')
                      ...
                      <a href="{{ route('admin.appointments.index') }}" class="btn btn-danger">Close &amp;&amp; Cancel</a>
