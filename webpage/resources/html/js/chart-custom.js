...
// calender js
if (jQuery('#appointment').length) {
    document.addEventListener('DOMContentLoaded', function() {
        var appointmentEl = document.getElementById('appointment');
        var appointment = new Fullappointment.appointment(appointmentEl, {
            plugins: ['dayGrid']
        });
        appointment.render();
    });
...
// calender 1 js
if (jQuery('#appointment1').length) {
    document.addEventListener('DOMContentLoaded', function() {
        var appointmentEl = document.getElementById('appointment1');

        var appointment1 = new Fullappointment.appointment(appointmentEl, {
